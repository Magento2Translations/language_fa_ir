...
# Version & progress
This translation is generated from the branch [2.2.7](https://crowdin.com/project/magento-2/fa#/2.2.7) at Crowdin and based on the Magento 2.2.7 sourcefiles.
There have been  8723 strings translated of the 10319 strings in the Magento source.
...
composer require magento2translations/language_fa_ir:2.2.7-dev
php bin/magento cache:clean
```
## Manually
To install this language package manually you need access to your server file system.
* Download the zip file [here](https://github.com/Magento2Translations/language_fa_ir/archive/2.2.7.zip).
